...
<?php
$str=array("´ó","¸ü","´´","Ìì","¿Æ","¿Í","²©","¼¼","Á¢","ÐÂ");
$word=strlen($str);
for($i=0;$i<4;$i++){
	$num=rand(0,$word*2-1);      //$word=$word*2-1
	$img=$img."<img src=' images/checkcode/".$num.".gif' width='16' height='16'>";    //ÏÔÊ¾Ëæ»úÍ¼Æ¬
	$pic=$pic.$str[$num];    //½«Í¼Æ¬×ª»»³ÉÊý×éÖÐµÄÎÄ×Ö
}
?>
        ...
        <tr>
		  ...
		  <table width="262" border="0" cellspacing="0" cellpadding="0">
            <tr align="left">
              ...
              <td width="71" class="word_white"><a href="index.php"><span style="FONT-SIZE: 9pt; COLOR: #000000; TEXT-DECORATION: none">Ê×  Ò³</span></a></td>
              <td width="87"><a href="file.php"><span  style="FONT-SIZE: 9pt; COLOR: #000000; TEXT-DECORATION: none">ÎÒµÄ²©¿Í</span></a></td>
              <td width="55"><a href="<?php echo (!isset($_SESSION[username])?'Regpro.php':'safe.php'); ?>"><span style="FONT-SIZE: 9pt; COLOR: #000000; TEXT-DECORATION: none"><?php echo (!isset($_SESSION[username])?"²©¿Í×¢²á":"°²È«ÍË³ö"); ?></span></a></td>
              <td width="23">&nbsp;</td>
            </tr>
          </table>
		  <br></td>
...
<?php echo $img; ?> &nbsp;
<input style="FONT-SIZE: 9pt"  type=submit value=µÇÂ¼ name=sub_dl onClick="return f_check(form)">
&nbsp; 
<?php
				}else{
			?>
				<font color="red"><?php echo $_SESSION[username]; ?></font>&nbsp;&nbsp;²©¿ÍÌì¿ÕÍøÕ¾»¶Ó­ÄúµÄ¹âÁÙ£¡£¡£¡µ±Ç°Ê±¼ä£º<font color="red"><?php echo date("Y-m-d l"); ?>
</font>
			<?
				}
			?>
		...
		<table width="100%" height="100%"  border="0" cellpadding="0" cellspacing="0">
		  ...
		  <tr>
			...
			?>
					...
					<tr>
					  <td  align="center">Í¼Æ¬Ãû³Æ£º<?php echo $info[tpmc];?></td>
					</tr>
					<?php 
			  }
			  ?>
