...
class ValidateCode {
	...
	//验证码图片高度
	private $mCheckImageHeight = '30';

	function __construct($width = '90', $height = '30', $nums = 4) {
		$this->mCheckImageWidth = $width;
		$this->mCheckImageHeight = $height;
		$this->mCheckCodeNum = $nums;
	}
	...
	public function CreateCheckCode() {
		$chars = 'ABCDEFGHJKLMNPQRSTUVWXYabcdefghijkmnpqrstuvwxy23456789';
		for ($i = 0; $i < $this->mCheckCodeNum; $i++) {
			$this->mCheckCode .= $chars[mt_rand(0, strlen($chars) - 1)];
		}
