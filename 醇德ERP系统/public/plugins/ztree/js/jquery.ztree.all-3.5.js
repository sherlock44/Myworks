...
(function($){
	...
	//portal root of excheck
	_initRoot = function (setting) {
		var r = data.getRoot(setting);
		r.radioCheckedList = [];
	},
	//portal cache of excheck
	_initCache = function(treeId) {},
	//portal bind event of excheck
	_bindEvent = function(setting) {
		var o = setting.treeObj,
		c = consts.event;
...
(function($){
	...
	//portal cache of exedit
	_initCache = function(treeId) {},
	//portal bind event of exedit
	_bindEvent = function(setting) {
		var o = setting.treeObj;
		var c = consts.event;
	...
	_view = {
		addEditBtn: function(setting, node) {
			...
			var aObj = $("#" + node.tId + consts.id.A),
			editStr = "<span class='button edit' id='" + node.tId + consts.id.EDIT + "' title='编辑节点' treeNode"+consts.id.EDIT+" style='display:none;'></span>";
			aObj.append(editStr);
		...
		addRemoveBtn: function(setting, node) {
			...
			var aObj = $("#" + node.tId + consts.id.A),
			removeStr = "<span class='button remove' id='" + node.tId + consts.id.REMOVE + "' title='删除节点' treeNode"+consts.id.REMOVE+" style='display:none;'></span>";
