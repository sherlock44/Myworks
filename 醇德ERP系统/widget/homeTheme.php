...
<body >
	<div id="navigation">
		<div class="container-fluid">
			<a href="<?=$this->url('index/main')?>" id="brand">后台管理</a>
			...
			<div class="user">
				...
				<div class="dropdown asdf">
					<a href="#" class='dropdown-toggle' data-toggle="dropdown"><?=$this->info['name']?><img src="/public/assets/sysadmin/img/demo/user-avatar.jpg" alt=""></a>
					<ul class="dropdown-menu pull-right">
						<li>
							<a href="<?=$this->url('system/website')?>">后台首页</a>
						</li>
						<li>
		...
		<div id="left" class="ui-sortable ui-resizable" style="display: block;">
			<form class="search-form" method="GET" action="search-results.html">
				...
				<ul class="subnav-menu">
					...
					<?foreach($this->menu['menu'][$this->pos]['items'] as $k=>$v){?>
						<li <?if($this->leftpos==$v['leftpos']){?>class="active"<?}?>>
						<a href="<?=$this->url($v['url'],array('type'=>$this->type))?>"><?=$v['title']?></a>
						</li>
					<?}?>		
				</ul>
				</div>
