		...
		<div class="container-fluid">
			...
			<div class="user">
				...
				<div class="dropdown asdf">
					<a href="#" class='dropdown-toggle' data-toggle="dropdown" id="commname"><?=$this->info['commname']?></a>
					<ul class="dropdown-menu pull-right">
						<li>
							<a href="<?=$this->url('index/editPassword')?>">修改密码</a>
						</li>
						<li>
...
$(function(){
    var id  = <?=$this->info['id']?>;
    $.getJSON('<?=$this->url("index/getCommname")?>',{id:id}),function(data){
        console.debug(data);
        $('#commname').text(data.commname);
    }
});
</script>