                            ...
                            <?
                                foreach($re as $key=>$val){
                                    ...
                                    <tr>
            							...
            							<td>
     								       <a data-original-title="查看订购商品" rel="tooltip" class="btn btn-small btn-success" href="<?=$this->url('purchase/payinfo',array('ordernum'=>$val['ordernum']))?>"><i class="icon-signout"></i></a>
