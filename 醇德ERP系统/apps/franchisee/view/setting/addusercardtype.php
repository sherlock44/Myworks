	...
	<div class="span12">
		<div class="box box-color box-bordered">
			...
			<div class="box-content nopadding">
				<form  class='form-horizontal form-bordered form-validate'	action='<?=$this->url("setting/insertusercardtype")?>'  id="login" name="login" method='post'>
					<div class="control-group">
						<label for="mobile" class="control-label">名称设置</label>
						<div class="controls">
							<input type="text" name="data[title]" id="title"   class="input-xlarge" data-rule-required="true" data-rule-mobile="false" data-rule-minlength="2">
...
//返回列表
	function returnList(){
		window.location.href="<?=$this->url('setting/usercardtype')?>";
	}
