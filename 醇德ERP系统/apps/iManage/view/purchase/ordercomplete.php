					     ...
					     <?
                                foreach($re as $key=>$val){
									...
									<td style="display:none;"><?=0-$val['created']?></td>
            							...
            							<td>
     								       <a data-original-title="查看订购商品" rel="tooltip" class="btn btn-xs btn-success" href="<?=$this->url('purchase/completeinfo',array('ordernum'=>$val['ordernum'],'token'=>$val['token']))?>"><i class="fa fa-backward"></i></a>
