                            ...
                            <tbody>
                                ...
                                <tr >
                                    ...
                                    <td>
                                        ...
                                        <?if(!empty($val['freeordernum'])){?>
                                        <a data-original-title="赠送订单" rel="tooltip" class="btn btn-xs btn-primary" href="<?=$this->url('purchasesr/freeorderlist',array('ordernum'=>$val['ordernum'],'token'=>$val['token']))?>"><i class="fa fa-gift"></i></a>
                                        <?}?>
                                        <?if($val['orderbackstatus']==0 && $val['status']>=3 && $val['status']<=5){?>
                                        <a title="退货" rel="tooltip" class="btn btn-xs btn-danger" href="<?=$this->url('orderback/add',array('ordernum'=>$val['ordernum'],'token'=>$val['token']))?>"><i class="fa fa-ban"></i></a>
                                        <?}?>
                                    </td>
                                </tr>
                                <?}?>
