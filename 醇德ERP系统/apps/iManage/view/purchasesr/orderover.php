                            ...
                            <tbody>
                                ...
                                <tr >
                                    ...
                                    <td>
                                        ...
                                        <a data-original-title="赠送订单" rel="tooltip" class="btn btn-xs btn-danger" href="<?=$this->url('purchasesr/freeorderlist',array('ordernum'=>$val['ordernum'],'token'=>$val['token']))?>"><i class="fa fa-gift"></i></a>
                                        <?}?>
                                    </td>
                                </tr>
                                <?}?>
