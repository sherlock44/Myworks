            ...
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        <a href="<?=$this->url("freeorder/apply")?>" class="btn btn-default btn-sm"> <i class="fa fa-plus"></i>
                            添加
                        </a>
                    </div>
                </div>
                            ...
                            <tbody>
                                ...
                                <tr >
                                    ...
                                    <td>
                                        ...
                                        <a data-original-title="退货" rel="tooltip" class="btn btn-xs btn-warning" href="<?=$this->url('orderback/add',array('ordernum'=>$val['ordernum'],'token'=>$val['token']))?>"><i class="fa fa-legal "></i></a>
                                        <?}?>
                                    </td>
                                </tr>
                                <?}?>
