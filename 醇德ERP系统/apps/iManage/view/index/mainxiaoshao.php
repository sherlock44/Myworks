						...
						<!--加盟商订货-->
                            <?
                                foreach($re as $key=>$val){
									...
									<td  style="display:none;"><?echo 0-$val['created'];?></td>
            							...
            							<td>
     								       <a data-original-title="查看详情" rel="tooltip" class="btn btn-xs btn-success" href="<?=$this->url('purchasesr/orderinfo',array('ordernum'=>$val['ordernum'],'token'=>$val['token']))?>"><i class="icon-signout"></i></a>
                            ...
                            <?
                                foreach($orderback as $key=>$val){
                                    ?>
                                    <tr>
									<td  style="display:none;"><?echo 0-$val['orderbackcreated'];?></td>
            							...
            							<td>
     								       <a data-original-title="查看详情" rel="tooltip" class="btn btn-xs btn-success" href="<?=$this->url('orderback/add',array('ordernum'=>$val['ordernum'],'token'=>$val['token']))?>"><i class="icon-signout"></i></a>
