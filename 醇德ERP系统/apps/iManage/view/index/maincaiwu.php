                            ...
                            <?
                                foreach($re as $key=>$val){
									...
									<td  style="display:none;"><?echo 0-$val['created'];?></td>
            							...
            							<td>
     								       <a data-original-title="查看详情" rel="tooltip" class="btn btn-xs btn-success" href="<?=$this->url('purchase/orderinfofr',array('ordernum'=>$val['ordernum'],'token'=>$val['token']))?>"><i class="icon-signout"></i></a>
                            ...
                            <?
                                foreach($orderback as $key=>$val){
									...
									<td  style="display:none;"><?echo 0-$val['created'];?></td>
            							...
            							<td>
     								       <a data-original-title="查看详情" rel="tooltip" class="btn btn-xs btn-success" href="<?=$this->url('orderback/orderinfocaiwu',array('ordernum'=>$val['ordernum'],'token'=>$val['token']))?>"><i class="icon-signout"></i></a>
                            ...
                            <?
                                foreach($cash as $key=>$val){
									...
									<td  style="display:none;"><?echo 0-$val['created'];?></td>
            							...
            							<td>
     								      <a data-original-title="查看" rel="tooltip" class="btn btn-xs btn-success" href="<?=$this->url('buyer/editapplycaiwu',array('id'=>$val['id']))?>"><i class="fa fa-sign-out"></i></a>
						                </td>
            						</tr>
                                    <?}?>
													<!--待处理采购计划-->
