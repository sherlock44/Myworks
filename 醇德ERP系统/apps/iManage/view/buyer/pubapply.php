            ...
            <table class="table table-bordered table-hover table-init">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a data-original-title="查看" rel="tooltip" class="btn btn-xs btn-success" href="<?=$this->url('buyer/editpubapply',array('id'=>$val['id']))?>"><i class="fa fa-edit"></i></a>
