...
<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li><a href="#">参数设置</a></li>
		<li class="active">收款类型</li>
	</ol>
</section>
<!-- Main content -->
<section class="content">
	<form  class='box box-primary form-validate' action='<?=$this->url("financial/updatepaytype")?>'  id="login" name="login" method='post'>
		<div class="box-header with-border">
			<h3 class="box-title">请填写收款类型信息</h3>
