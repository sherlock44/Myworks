        ...
        <div class="row">
          <div class="col-xs-8">
            <div class="checkbox icheck">
              <label>
                <img src="/index.php/iManage/common/yzmCode" alt="验证码" class='retina-ready' width="100"
                style="margin-top: -13px;" title="点击更换验证码" onclick="$(this).attr('src','/index.php/iManage/common/yzmCode?'+ new Date().getTime())"></label>
              </div>
            </div>
            <!-- /.col -->
            <div class="col-xs-4">
        ...
        $.ajax({
          ...
          success:function(r){
            if(r.state == 1){
             ...
             $("#yzmCode").attr('src','/index.php/iManage/common/yzmCode?'+ new Date().getTime());
           }
         }
       });
        return false;
