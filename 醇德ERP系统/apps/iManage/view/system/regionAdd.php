...
<div id="pub_edit_bootbox" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-header">
        ...
        <div class="modal-body">
			<form id="pub_form" class="form-horizontal" method="POST" action="<?=$this->url('system/'.$form_action)?>">
				<div class="control-group">
					<label class="control-label" style="width: 80px;">名称：</label>
					<div class="controls" style="margin-left: 100px;">
						<input type="text" class="input-xlarge" value="<?=!empty($info['region_name']) ? $info['region_name'] : ''?>" name="region_name">
					</div>
				</div>
