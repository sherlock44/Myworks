			...
			<div class="row">
				...
				<div class="col-md-6">
					...
					<div class="form-group">
						<label for="uname">账号名称</label>
						<input type="text" data-rule-minlength="1"  data-rule-required="true" class="form-control valid" value=""  id="uname" name="uname">
					</div>
					<div class="form-group">
						<label for="address">公司职务</label>
						<input type="text" placeholder="公司职务" data-rule-minlength="1"  data-rule-required="true" class="form-control" value="" id="address" name="data[jobpost]">
					</div>
					<div class="form-group">
				...
				<div class="col-md-6">
					...
					<div class="form-group">
						...
						<input type="password" maxlength="20" name="password" id="password" value="" placeholder="请填写6-20位长度的密码" class="form-control" data-rule-required="true"  data-rule-minlength="6">
					</div>
					<div class="form-group">
						<label for="pwd">确认密码</label>
						<input type="password" maxlength="20" name="pwd" id="pwd" value="" placeholder="请再次确认密码" class="form-control" data-rule-required="true" data-rule-minlength="6">
					</div>
					<div class="form-group">
						<label for="email">邮箱</label>
						<input type="text" name="data[email]" id="email" value="<?=empty($re['email'])?'':$re['email']?>" class="form-control" data-rule-required="true" data-rule-minlength="2">
					</div>
					<div class="form-group">
