		...
		<div class="box box-color box-bordered">
			...
			<div class="box-content nopadding">
				...
				<div id="DataTables_Table_0_length" class="dataTables_length" style="height:36px;">				
					<form action="<?=$this->url("storeout/selgoods")?>" method="GET"  id="bb">
			...
			<form  class='form-horizontal form-bordered form-validate'	action='<?=$this->url("storeout/addcart")?>'  id="logins" name="logins" method='post'>
				...
				<button class="btn btn-success" onclick="formcarttj()" ><i class="icon-ambulance"></i>&nbsp;&nbsp;确认</button>
				<button class="btn btn-primary" onclick="javascript:window.location.href='<?=$this->url("storeout/cartlist",array('applyid'=>$id))?>'" ><i class="icon-shopping-cart"></i>&nbsp;&nbsp;购物车列表</button>
				</div>
				<?=$pageHtml?>
			</div>
