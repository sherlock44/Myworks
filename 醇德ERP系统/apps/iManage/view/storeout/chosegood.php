    ...
    <div class="span12">
        <div class="box box-color box-bordered">
            ...
            <div class="box-content nopadding">
                <form  class='form-horizontal form-bordered form-validate' action='<?=$this->url("storeout/chosegood")?>'  id="login" name="login" method='post'>                                
                    ...
                    <div class="control-group">
                     ...
                     <div class="control-group">
                        <label class="control-label">选择出库类型</label>
                        <div class="controls">
                            <select data-rule-required="true" name="data[cktp]">
                    ...
                    <div class="control-group">
                        <label class="control-label">选择入库类型</label>
                        <div class="controls">
                            <select data-rule-required="true" name="data[rktp]">
                                    <option value="">请选择</option>
                                <?
                                    foreach($rk as $k=>$v){?>
                                        <option value="<?=$v['id']?>"><?=$v['title']?></option>
