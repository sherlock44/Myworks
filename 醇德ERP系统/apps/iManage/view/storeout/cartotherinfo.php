...
<form  class='form-horizontal form-bordered form-validate'	action='<?=$this->url('storeout/tjcart')?>'  id="login" name="login" method='post'>
        <div class="row-fluid">
        	<div class="span12">
		...
		<div class="box box-color box-bordered">
			...
			<div class="box-content nopadding">
				...
				<div class="control-group">
						...
						<div class="controls">
							<textarea  rows="3" name="data[outremark]" class="span8" id="outremark"></textarea>
						</div>
				</div>
