	...
	function changehouse(goodsid,houseposid,houseid){
		...
		if(houseid==0){
			...
			$.ajax({
				...
				url:"<?=$this->url('storeout/getHousePos')?>",
				type:"post",
				dataType:"json",
...
<div class="row-fluid">
        	<div class="span12">
        		<div class="box box-color box-bordered">
					...
					<form  class='form-horizontal form-bordered form-validate'	action='<?=$this->url("storeout/goodstostoretj")?>'  id="formtj" name="formtj" method='post'>
