                        ...
                        <table class="table table-bordered table-hover table-init">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a data-original-title="查看退货单" rel="tooltip" class="btn btn-xs btn-success" href="<?=$this->url('orderback/orderinfocaiwu',array('ordernum'=>$val['ordernum'],'token'=>$val['token']))?>"><i class="fa fa-edit"></i></a>
                                    </td>
                                </tr>
                                <?}?>
                            </tbody>
