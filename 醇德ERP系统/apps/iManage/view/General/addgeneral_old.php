	...
	<div class="span12">
		<div class="box box-color box-bordered">
			...
			<div class="box-content nopadding">
				<form  class='form-horizontal form-bordered form-validate'	action='<?=$this->url("General/insertshop")?>'  id="login" name="login" method='post'>
					...
					<div class="control-group">
						...
						<div class="controls">
                            ...
                            <input type="text" name="data[arrive]" id="arrive" value="<?=!empty($re) ? $re["arrive"] : ''?>" class="input-xlarge" data-rule-required="true"  data-rule-minlength="1" >
					...
					<div class="control-group">
						...
						<div class="controls">
                            <input type="text" name="data[Summerprice]" id="Summerprice" value="<?=!empty($re) ? $re["Summerprice"] : ''?>" class="input-xlarge" data-rule-required="true" data-rule-number="true" data-rule-minlength="1">
					...
					<div class="control-group">
						...
						<div class="controls">
                            <input type="text" name="data[milliontons]" id="milliontons" value="<?=!empty($re) ? $re["milliontons"] : ''?>" class="input-xlarge" data-rule-required="true" data-rule-number="true" data-rule-minlength="1">
					...
					<div class="control-group">
						...
						<div class="controls">
                            <input type="text" name="data[elementbox]" id="elementbox" value="<?=!empty($re) ? $re["elementbox"] : ''?>" class="input-xlarge" data-rule-required="true" data-rule-number="true" data-rule-minlength="1">
					...
					<div class="control-group">
						...
						<div class="controls">
                            <input type="text" name="data[pricesinwinter]" id="pricesinwinter" value="<?=!empty($re) ? $re["pricesinwinter"] : ''?>" data-rule-number="true" class="input-xlarge" data-rule-required="true" data-rule-minlength="1">
					...
					<div class="control-group">
						<label for="mobile" class="control-label">元(吨)</label>
						<div class="controls">
                            <input type="text" name="data[dunyuan]" id="dunyuan" value="<?=!empty($re) ? $re["dunyuan"] : ''?>" data-rule-number="true" class="input-xlarge" data-rule-required="true" data-rule-minlength="1">
                        </div>
					</div>
					<div class="control-group">
						<label for="mobile" class="control-label">元(箱)</label>
						<div class="controls">
                            <input type="text" name="data[xiangyuan]" id="xiangyuan" value="<?=!empty($re) ? $re["xiangyuan"] : ''?>" data-rule-number="true" class="input-xlarge" data-rule-required="true" data-rule-minlength="1">
                        </div>
					</div>
					<div class="control-group">
						<label for="mobile" class="control-label">运送时间</label>
