...
<section class="content">
	<form class="box box-default form-validate" id="myform" action='<?=$this->url("General/insertcategory")?>'>
			...
			<div class="row">
				<div class="col-xs-6">
					...
					<div class="form-group">
						...
						<textarea type="text" rows="5" name="data[remark]" id="remark" value="<?=!empty($re) ? $re["brief"] : ''?>" class="form-control" data-rule-required="true" data-rule-minlength="2"></textarea>
					</div>
					<div class="form-group">
