	...
	<div class="span12">
		<div class="box box-color box-bordered">
			...
			<div class="box-content nopadding">
				<form  class='form-horizontal form-bordered form-validate'	action='<?=$this->url("General/uploados")?>'  id="login" name="login" method='post'>
					...
					<div class="control-group">
						<label for="mobile" class="control-label">下载地址</label>
						<div class="controls">
                           <?="http://".ROOT_URL.$re['document']?>
                        </div>
					</div>
