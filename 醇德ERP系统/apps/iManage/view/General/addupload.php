	...
	<div class="span12">
		<div class="box box-color box-bordered">
			...
			<div class="box-content nopadding">
				<form  class='form-horizontal form-bordered form-validate'	action='<?=$this->url("General/addone")?>'  id="login" name="login" method='post'>
					
					<div class="control-group">
						<label for="mobile" class="control-label">文件名</label>
						<div class="controls">
                            <input type="text" name="data[name]" id="name" value="<?=!empty($re) ? $re["name"] : ''?>" class="input-xlarge" data-rule-required="true" data-rule-minlength="1">
                        </div>
					</div>
					<div class="control-group">
						<label for="mobile" class="control-label">简介</label>
						<div class="controls">
                            <textarea type="text" name="data[brief]" id="brief" value="<?=!empty($re) ? $re["brief"] : ''?>" class="input-xlarge" data-rule-required="true" data-rule-minlength="1"></textarea>
                        </div>
					</div>
					<div class="control-group">
