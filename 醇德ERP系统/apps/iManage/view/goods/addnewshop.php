	...
	<div class="span12">
		<div class="box box-color box-bordered">
			...
			<div class="box-content nopadding">
				<form  class='form-horizontal form-bordered form-validate'	action='<?=$this->url("goods/insertnewshop")?>'  id="login" name="login" method='post'>
					...
					<div class="control-group">
						...
						<div class="controls">
                            <input type="text" name="data[percent]" id="percent" value="<?=!empty($re) ? $re["percent"] : ''?>" class="input-xlarge" data-rule-required="false" data-rule-minlength="0">
					...
					<div class="control-group">
						...
						<div class="controls">
                            <input type="text" name="data[specs]" id="specs" value="<?=!empty($re) ? $re["specs"] : ''?>" class="input-xlarge" data-rule-required="false" data-rule-minlength="0">
						...
						<div class="controls">
                            <select name="data[branduuid]">
								<?foreach ($brand as $key => $vals) {?>
									<option value="<?=$vals['id']?>" <?=!empty($re) && $re['branduuid']==$vals['id']?'selected':''?>><?=$vals['title']?></option>
								<?}?>
							</select>
					...
					<input type='hidden'  name="data[isnew]" value='1'>
