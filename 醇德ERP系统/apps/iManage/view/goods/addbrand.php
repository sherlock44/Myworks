...
<section class="content">
	<form class="box box-default form-validate" action='<?php echo $this->url("goods/insertbrand");?>' id="myform" name="add_brand" method='post'>
					...
					<div class="form-group">
						...
						<div class="fileupload fileupload-new" data-provides="fileupload">
							<div class="fileupload-new thumbnail" style="width: 150px; max-height: 150px;">
								<img src="<?php echo !empty($re) ? $re['icon'] : '/public/assets/sysadmin/img/200_200_no_image.gif'?>" />
							</div>
