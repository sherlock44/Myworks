...
<section class="content">
	<form class="box box-default form-validate" id="myform" action='<?=$this->url("goods/insertshop")?>'>
			...
			<div class="row">
				<div class="col-xs-6">
					...
					<div class="form-group">
						...
						<div class="input-group">
							...
							<span class="input-group-btn">
								<button title="随机生成条码" data-toggle="tooltip" class="btn btn-success btn-flat" onclick="getbarcode('')"><i class="fa fa-refresh"></i></button>
							</span>
						</div><!-- /input-group -->
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<input type="text" readonly="true" name="data[number]" id="number" value="<?=!empty($re) ? $re["number"] : ''?>" data-rule-number="true" class="form-control"  placeholder="只能填数字">
					</div>
					<div class="form-group">
				...
				<div class="col-xs-6">
					...
					<div class="form-group">
						...
						<div class="input-group">
							...
							<span class="input-group-btn">
								<button title="根据条码生成编码" data-toggle="tooltip" class="btn btn-warning btn-flat" onclick="geterpcode('')"><i class="fa fa-refresh"></i></button>
							</span>
						</div><!-- /input-group -->
					</div>
					<div class="form-group">
