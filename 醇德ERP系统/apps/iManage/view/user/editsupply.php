...
<section class="content">
  <form  class='box box-primary form-validate' action='<?=$this->url("user/updatesupply")?>'  id="login" name="login" method='post'>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="form-group">
            ...
            <input type="text" name="data[title]" id="title" value="<?=$re['title']?>"  class="form-control valid" data-rule-required="true" data-rule-mobile="false" data-rule-minlength="1">
          </div>
          <div class="form-group">
            <label for="name">供应商类型</label>
            <select name='data[type]' class="form-control valid">
              <?foreach($supplytype as $val){?>
              <option value="<?=$val['id']?>"  <?if($re['type']==$val['id']){echo "selected";}?>><?=$val['title']?></option>
              <?}?>
            </select>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <select name='data[status]' class="form-control ">
              <option value='1'  <?if($re['status']==1){echo "selected";}?>>正常</option>
              <option value='0'  <?if($re['status']==0){echo "selected";}?>>冻结</option>
            </select>
          </div>
        </div>
        <div class="col-md-6">
          ...
          <div class="form-group">
            ...
            <input type="text" name="data[mobile]" id="mobile" value="<?=$re['mobile']?>"  class="form-control valid" data-rule-required="true" data-rule-mobile="false" data-rule-minlength="1">
          </div> 
          <div class="form-group">
            <label >简介说明</label>
