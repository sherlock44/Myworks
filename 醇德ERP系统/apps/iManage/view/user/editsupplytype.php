...
<section class="content">
	<form  class='box box-primary form-validate' action='<?=$this->url("user/updatesupplytype")?>'  id="login" name="login" method='post'>
		<div class="box-header with-border">
			<h3 class="box-title">请填写供应商类型信息</h3>
...
<script>
	function returnList(){
		window.location.href="<?=$this->url('user/supplytype')?>";
	}
</script>
