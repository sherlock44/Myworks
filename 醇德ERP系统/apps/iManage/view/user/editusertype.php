...
<section class="content">
	<form  class='box box-primary form-validate' action='<?=$this->url("user/updateusertype")?>'  id="login" name="login" method='post'>
		<div class="box-header with-border">
			<h3 class="box-title">请填写客户类型信息</h3>
...
<script>
	function returnList(){
		window.location.href="<?=$this->url('user/usertype')?>";
	}
</script>