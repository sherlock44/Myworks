...
<section class="content-header">
  <h1>
    出库设置
    <small>编辑出库类型信息</small>
  </h1>
  <ol class="breadcrumb">
    <li><a href="<?=$_SESSION['indexmain']?>"><i class="fa fa-home"></i> ERP系统</a></li>
    <li><a href="#">参数设置</a></li>
    <li class="active">出库设置</li>
  </ol>
</section>
<!-- Main content -->
<section class="content">
  <form  class='box box-primary form-validate' action='<?=$this->url("preferences/updatestorageout")?>'  id="login" name="login" method='post'>
    <div class="box-header with-border">
      <h3 class="box-title">编辑出库设置</h3>
...
<script>
  function returnList(){
    window.location.href="<?=$this->url('preferences/storageout')?>";
  }
</script> 
