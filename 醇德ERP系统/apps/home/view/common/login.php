...
<body class='login' style="background-image: url('/public/assets/sysadmin/img/1.jpg');background-repeat: no-repeat;background-position: center;">
	<div class="wrapper">
		<h1><a href="javascript:;">系统管理平台</a></h1>
		<div class="login-body">
			...
			<form action="" id="login" name="login" method='post'>
				...
				<div class="submit">
					<img src="/index.php/home/common/yzmCode" alt="验证码" class='retina-ready' width="100" style="margin-top: -13px;" title="点击更换验证码" onclick="$(this).attr('src','/index.php/sysadmin/common/yzmCode?'+ new Date().getTime())">
...
$('#login').submit(function(){
	...
	$.ajax({
		//alert(data);
		type:'POST',
		url:'<?php echo $this->url("common/checkLogin")?>',
		data:data,
		dataType:'json',
		success:function(r){
			if(r.state == 1){
